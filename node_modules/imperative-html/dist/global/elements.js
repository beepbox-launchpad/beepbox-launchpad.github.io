(function (exports) {
    ...
    if (typeof Proxy !== "undefined") {
        ...
        exports.HTML = new Proxy(parseHTML, {
        ...
        exports.SVG = new Proxy(parseSVG, {
            get: function (target, name) {
        ...
        var _loop_2 = function (name_2) {
            ...
            if (/-/.test(name_2)) {
                ...
                exports.SVG[snakeCaseName] = function () {
                    var args = [];
                    for (var _i = 0; _i < arguments.length; _i++) {
                        args[_i] = arguments[_i];
                    }
    ...
    exports.applyToElement = applyToElement;
    exports.replaceScriptWith = replaceScriptWith;
